...
function vdsl_admin_styles_scripts() {
	wp_enqueue_style( 'vdsl-admin-styles', plugins_url() . '/localisation/assets/css/vdsl-admin.css', array(), '1.0.0' );
// 	wp_enqueue_script( 'vdsl-admin-scripts', plugins_url() . '/wpc-functions/assets/js/vdsl-admin.js', array( 'jquery' ), '1.0.0', true );
}
