<?php get_header(); ?>
			...
			<div class="infos">
				...
				<div class="xpert-coord">
					...
					<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
						...
						<p class="phone"><?php _e( 'Phone:', 'vdsl' ); ?>
						...
						<p><?php _e( 'RBQ:', 'vdsl' ); ?> <?php the_field('rbq_detaillant'); ?></p>
						<?php $apchq = get_field('apchq'); ?>
							<?php if( $apchq == 'oui' ){ ?>
								<p><?php _e( 'APCHQ Member', 'vdsl' ); ?></p>
	...
	<div class="page-content">
		...
		<div class="col-lg-12">
			<div class="toggle">
				<h2 id="toggle1"><?php _e( 'Quebec', 'vdsl' ); ?></h2>
			...
			<div class="toggle">
				<h2 id="toggle2"><?php _e( 'New-Brunswick', 'vdsl' ); ?></h2>
			...
			<div class="toggle">
				<h2 id="toggle3"><?php _e( 'Ontario', 'vdsl' ); ?></h2>
