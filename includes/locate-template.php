 ...
 */
function vdsl_locate_template( $template_name, $template_path = '', $default_path = '' ) {
	...
	return apply_filters( 'vdsl_locate_template', $template, $template_name, $template_path, $default_path );
}